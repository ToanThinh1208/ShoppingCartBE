...
//constructor là cái phễu dùng để tạo ra 1 object errorWithStatus có 2 thuộc tính là message, status
//trong constructor sẽ nhận 1 object có message và status, sau đó dùng 2 parameter để đúc ra 1 errorWithStatus
